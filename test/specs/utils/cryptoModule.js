					...
					Given(
						...
						() => {
							When(
								...
								() => {
									Then(
										'lisk-js crypto should be used to sign the transaction',
										then.liskJSCryptoShouldBeUsedToSignTheTransaction,
									);
									Then(
										'the signature should be returned',
										then.theSignatureShouldBeReturned,
							...
							When(
								'an error occurs attempting to sign the transaction using the passphrase',
								when.anErrorOccursAttemptingToSignTheTransactionUsingThePassphrase,
								() => {
									Then(
										'the error response should be handled',
										then.theErrorResponseShouldBeHandled,
